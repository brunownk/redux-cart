...
export const sizes = {
  ...
  only: {
    sm: `(min-width: ${breakpoints[0]}px) and (max-width: ${breakpoints[1] - 1}px)`,
    md: `(min-width: ${breakpoints[1]}px) and (max-width: ${breakpoints[2] - 1}px)`,
    lg: `(min-width: ${breakpoints[2]}px) and (max-width: ${breakpoints[3] - 1}px)`,
  }
}
